...
Remaining for the whole book: the deferred **Chapter 6** (object formats and
loaders — needs tooling only on the Mac), the fourteen reference **appendices**
(A–N), and the front matter (preface, how-to-use). See
